...
class MyAppointmentList extends StatefulWidget {
  ...
  @override
  MyAppointmentListState createState() => MyAppointmentListState();
}

class MyAppointmentListState extends State<MyAppointmentList> {
                  ...
                  child: Column(
                    ...
                    children: [
                      SvgPicture.asset('assets/images/no_scheduled.svg',
                          width: 250),
                      Text('لا يوجد حجوزات قادمة', style: getbodyTextStyle()),
                    ],
                  ),
                )
              : ListView.builder(
